	...
	<view class="">
		...
		<view class="price">
			<view class="col" >
				...
				<view class="number">{{recommendList.houseDeal.price}}.0元</view>
			</view>
			<view class="col">
				<view class="label">单价</view>
				<view class="number">{{recommendList.houseResponse.avgPrice}}/㎡</view>
			</view>
		...
		<view class="info">
			...
			<view class="row">
				<view class="col">
					...
					<view class="value">{{recommendList.houseResponse.dealTime|date('YYYY-MM-DD')}}</view>
				</view>
				<view class="col">
			...
			<view class="row">
				<view class="col">
					...
					<view class="value">{{recommendList.houseResponse.floorNumber+"/"+recommendList.houseResponse.floorCount}}</view>
				</view>
				<view class="col">
			...
			<view class="row">
				<view class="col">
					...
					<view class="value">{{recommendList.houseDeal.buildingYear}}</view>
				</view>
				<view class="col">
					<view class="label">结构:</view>
					<view class="value">{{recommendList.houseDeal.structure}}</view>
				</view>
			</view>
			<view class="row">
				<view class="col">
		...
		<view class="desc block">
			...
			<view class="content">
				{{recommendList.houseResponse.remark}}
			</view>
			<view class="">
